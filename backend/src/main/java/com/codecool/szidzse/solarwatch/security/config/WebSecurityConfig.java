...
import com.codecool.szidzse.solarwatch.security.jwt.AuthEntryPointJwt;
import com.codecool.szidzse.solarwatch.security.jwt.AuthTokenFilter;
        ...
        http.csrf(csrf -> csrf.disable()).cors(cors -> cors.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/member/**").permitAll()
                                .requestMatchers("/api/sunrise-sunset/**").hasRole("USER")
                                .requestMatchers("/api/cities/**").hasRole("USER")
